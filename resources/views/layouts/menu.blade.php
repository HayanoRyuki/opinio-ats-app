...
<nav class="sidebar">
    ...
    <div style="flex:1; overflow-y:auto;">
        ...
        <ul style="list-style:none; padding:0; margin:0;">
            ...
            <li class="sidebar-menu-item"><a href="{{ route('settings.account') }}" style="color:#fff;">アカウント設定</a></li>
            <li class="sidebar-menu-item"><a href="{{ route('settings.billing') }}" style="color:#fff;">利用プラン・請求</a></li>
            <li class="sidebar-menu-item"><a href="{{ route('announcements') }}" style="color:#fff;">お知らせ</a></li>
            <li class="sidebar-menu-item"><a href="{{ route('data.policy') }}" style="color:#fff;">データポリシー</a></li>
...
<main class="main-content"
      style="margin-left:{{ $isLoginPage ? '0' : '220px' }};">
    @yield('content')
</main>
